<template>
  <div id="app">
    ...
    <div id="text3">Our Artificial Intelligence powered tools use millions of project data
      <div>
        points
      ...
      <div id="img1">
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64">
          <g fill="none">
            ...
            ></path>
            <path fill="#333637" d="M24.327 47.661l-3.994-3.994L3.975 60.025 7.951 64z"></path>
          </g>
        </svg>
      </div>
    </div>
      ...
      <div id="img2">
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64">
          <g fill="none">
            ...
            <path fill="#DADAE5" d="M64 14.454v41.788H32V10.667h28.25z"></path>
            <path fill="#474F54" d="M0 0h64v15.515H0z"></path>
            <path fill="#32393F" d="M32 0h32v15.515H32z"></path>
            <g fill="#FF637B">
              <path
            ...
            ></path>
            <path fill="#DADAE5" d="M11.636 22.303h41.697v3.879H11.636z"></path>
            <path fill="#C9C9D3" d="M32 22.303h20.364v3.879H32z"></path>
            <path fill="#E63950" d="M45.576 42.245V64H33.939v-3.71H32V32.97h1.435z"></path>
            <path fill="#EFEFF4" d="M30.061 45.576h3.878v3.879h-3.878z"></path>
            <path fill="#DADAE5" d="M32 45.576h1.939v3.879H32z"></path>
            <path
              fill="#676E74"
              d="M50.424 45.779l-2.452 2.706-15.487-13.526-15.488 13.526-2.452-2.706 17.94-15.718z"
            ></path>
            <path fill="#474F54" d="M32 30.061l18.424 15.718-2.518 2.706L32 34.959z"></path>
          </g>
        </svg>
      </div>
    </div>
    ...
    <div id="box3">
      ...
      <div id="img3">
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64">
          <g fill="none">
            <path fill="#676E74" d="M26.375 52.625h11.25V64h-11.25z"></path>
            <path fill="#333637" d="M32 52.625h5.625V64H32z"></path>
            <path fill="#4C545A" d="M22.625 47h18.75v9.375h-18.75z"></path>
            <path fill="#52585C" d="M32 47h9.375v9.375H32z"></path>
            <path
              fill="#FFDA2D"
            ...
            ></path>
            <path fill="#676E74" d="M18.875 45.125h26.25v3.75h-26.25z"></path>
            <path fill="#FF9100" d="M39.956 10.143l2.651 2.651-3.979 3.978-2.651-2.651z"></path>
            <path
              fill="#FDBF00"
            ...
            ></path>
            <path fill="#FF9100" d="M32 7.625h1.875v5.625H32zM32 28.25h1.875v5.625H32z"></path>
            <path fill="#333637" d="M32 45.125h13.125v3.75H32z"></path>
            <path
              fill="#FDBF00"
            ...
            <path fill="#FDBF00" d="M32 18.875h1.875v3.75H32z"></path>
          </g>
        </svg>
      </div>
    </div>
    ...
    <div id="box4">
      ...
      <div id="img4">
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64">
          <g fill="none">
            <path fill="#474F54" d="M64 0v41.25l-3.75 3.875H3.75L0 41.25V0z"></path>
            <path fill="#32393F" d="M64 0v41.25l-3.75 3.875H32V0z"></path>
            <path fill="#DADAE5" d="M22.625 50.875h18.75v11.25h-18.75z"></path>
            <path fill="#C9C9D3" d="M32 50.875h9.375v11.25H32z"></path>
            <path fill="#EFEFF4" d="M0 41.25h64v11.5H0z"></path>
            <path fill="#DADAE5" d="M32 41.25h32v11.5H32z"></path>
            <path fill="#EFEFF4" d="M15.125 60.25h33.75V64h-33.75z"></path>
            <path fill="#DADAE5" d="M32 60.25h16.875V64H32z"></path>
            <path
              fill="#549EF2"
